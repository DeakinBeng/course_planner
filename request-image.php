<?php
$apikey = "7e9d939916453f76"; //please input your RESTful api key here.
$api_url = "http://api.page2images.com/html2image";
$html = '<link rel="stylesheet" type="text/css" href="http://www.deakincourseplanner.com/wip/css/style.css">'.$_POST['p2i_html'];

call_p2i();

function call_p2i()
{
    global $apikey, $api_url, $html;
